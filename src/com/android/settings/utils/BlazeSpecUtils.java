...
public class BlazeSpecUtils {
    private static final String DEVICE_NAME_MODEL_PROPERTY = "ro.product.system.model";
    private static final String BLAZE_CPU_MODEL_PROPERTY = "ro.blaze.cpu";
    ...
    public static String getProcessorModel() {
        String cpuModelBlaze = SystemProperties.get(BLAZE_CPU_MODEL_PROPERTY);
        String cpuModelFallback = SystemProperties.get(FALLBACK_CPU_MODEL_PROPERTY);
        if (!cpuModelBlaze.isEmpty()) {
            return cpuModelBlaze;
